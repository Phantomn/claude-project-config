...
> **AKM Index v1.2**로 "내 지식관리 시스템이 AI 에이전트와 함께 얼마나 성숙하게 굴러가는가"를 0–100점으로 측정하는 Claude Code 스킬.
> 공식 사이트: **https://akm.cmdspace.work** · 참여 안내: **https://akm.cmdspace.work/submit.html**

[![AKM Index](https://img.shields.io/badge/AKM%20Index-v1.2-134538)](https://akm.cmdspace.work)
...
└── references/
    ├── rubric.md                 # AKM Index v1.2 루브릭 전문 (한국어 · 채점 앵커는 v1.1 불변)
    ├── rubric-en.md              # 영문판
